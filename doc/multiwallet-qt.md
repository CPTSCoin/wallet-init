...
In order to support loading of multiple wallets in cpts-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cpts.cpp.
...
Changes to cpts.cpp
----------------------
cpts.cpp is the entry point into cpts-qt, and as such, will require some minor modifications to provide hooks for
