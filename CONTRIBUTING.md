Contributing to CPTS Core
============================

The CPTS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CPTS Core project, and is not to be
confused with overall CPTS Network Protocol consensus changes.

Whether a pull request is merged into CPTS Core rests with the project merge
...
Patches that change CPTS consensus rules are considerably more involved than
...
Where a patch set proposes to change the CPTS consensus, it must have been
...
The project leader is the release manager for each CPTS Core release.
