/* src/config/cpts-config.h.  Generated from cpts-config.h.in by configure.  */
/* src/config/cpts-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CPTS_CONFIG_H

#define CPTS_CONFIG_H
...
#define PACKAGE_BUGREPORT "crypto-points.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CPTS Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CPTS Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cpts"
