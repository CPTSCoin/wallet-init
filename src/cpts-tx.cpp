...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CPTS Core cpts-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cpts-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cpts transaction") + "\n" +
                               "  cpts-tx [options] -create [commands]   " + _("Create hex-encoded cpts transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cpts transaction
