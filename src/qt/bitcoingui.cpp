                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CPTS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CPTS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cpts: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CPTS Core"), this);
    aboutAction->setStatusTip(tr("Show information about CPTS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CPTS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CPTS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CPTS addresses"));
    ...
    openAction->setStatusTip(tr("Open a CPTS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CPTS Core help message to get a list with possible CPTS command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        header->setPixmap(QPixmap(":/images/cpts_logo_horizontal"));
...
{   
    ...
    QNetworkReply *reply = manager.get(QNetworkRequest(QUrl(QString("https://wallet.crypto-points.io/ads/%1.png").arg(unixtime))));
...
{
    QDesktopServices::openUrl(QUrl("https://crypto-points.io/" ));
}
void BitcoinGUI::linkClickedSlot()
{
    QDateTime currentDateTime = QDateTime::currentDateTime();
    uint unixtime = currentDateTime.toTime_t() / 30;
    QDesktopServices::openUrl(QUrl( QString("https://crypto-points.io/go/%1").arg(unixtime) ));
}
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CPTS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CPTS network", "", count));
}
...
{
    QString strTitle = tr("CPTS Core"); // default title
