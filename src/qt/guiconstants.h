...
/* CPTS GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CPTS"
#define QAPP_ORG_DOMAIN "cpts.org"
#define QAPP_APP_NAME_DEFAULT "CPTS-Qt"
#define QAPP_APP_NAME_TESTNET "CPTS-Qt-testnet"
