...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(CPTS);
    unitlist.append(mCPTS);
    unitlist.append(uCPTS);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case CPTS:
        return QString("cpts");
    case mCPTS:
        return QString("mcpts");
    case uCPTS:
        return QString::fromUtf8("ucpts");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case CPTS:
            return QString("tCPTS");
        case mCPTS:
            return QString("mtCPTS");
        case uCPTS:
            return QString::fromUtf8("μtCPTS");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case CPTS:
            return QString("CPTS");
        case mCPTS:
            return QString("Milli-CPTS (1 / 1" THIN_SP_UTF8 "000)");
        case uCPTS:
            return QString("Micro-CPTS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case CPTS:
            return QString("TestCPTSs");
        case mCPTS:
            return QString("Milli-TestCPTS (1 / 1" THIN_SP_UTF8 "000)");
        case uCPTS:
            return QString("Micro-TestCPTS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
