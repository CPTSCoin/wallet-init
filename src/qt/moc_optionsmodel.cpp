...
QT_MOC_LITERAL(7, 108, 28), // "anonymizeCPTSAmountChanged"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->anonymizeCPTSAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeCPTSAmountChanged)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void OptionsModel::anonymizeCPTSAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
