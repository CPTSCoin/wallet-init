...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The CPTS address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        payTo->setInputMask(QString());
        payTo->setPlaceholderText(QApplication::translate("SendCoinsEntry", "Enter a CPTS address (e.g. PCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the CPTS: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the CPTS network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
