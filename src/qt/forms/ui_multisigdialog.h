...
public:
    ...
    void setupUi(QDialog *MultisigDialog)
    {
        ...
        addAddressWidget->setGeometry(QRect(0, 0, 761, 166));
        ...
        txInputsWidget->setGeometry(QRect(0, 0, 749, 134));
        ...
        destinationsScrollAreaContents->setGeometry(QRect(0, 0, 749, 134));
...
"}"));
        ...
        keyScrollAreaContents->setGeometry(QRect(0, 0, 755, 73));
...
#ifndef QT_NO_TOOLTIP
        addDestinationButton->setToolTip(QApplication::translate("MultisigDialog", "Add destinations to send CPTS to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
