...
public:
    ...
    void setupUi(QDialog *MultiSendDialog)
    {
        ...
        MultiSendDialog->resize(594, 616);
    ...
    void retranslateUi(QDialog *MultiSendDialog)
    {
        ...
        label_2->setText(QApplication::translate("MultiSendDialog", "MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other CPTS addresses after it matures.\n"
