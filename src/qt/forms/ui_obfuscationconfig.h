...
public:
    ...
    void retranslateUi(QDialog *ObfuscationConfig)
    {
        ...
        label_2->setText(QApplication::translate("ObfuscationConfig", "Use 2 separate masternodes to mix funds up to 50000 CPTS", Q_NULLPTR));
        label_3->setText(QApplication::translate("ObfuscationConfig", "Use 8 separate masternodes to mix funds up to 50000 CPTS", Q_NULLPTR));
        label_4->setText(QApplication::translate("ObfuscationConfig", "Use 16 separate masternodes", Q_NULLPTR));
        label_6->setText(QApplication::translate("ObfuscationConfig", "This option is the quickest and will cost about ~0.025 CPTS to anonymize 50000 CPTS", Q_NULLPTR));
        label_7->setText(QApplication::translate("ObfuscationConfig", "This option is moderately fast and will cost about 0.05 CPTS to anonymize 50000 CPTS", Q_NULLPTR));
        ...
        label_9->setText(QApplication::translate("ObfuscationConfig", "0.1 CPTS per 50000 CPTS you anonymize.", Q_NULLPTR));
    } // retranslateUi
