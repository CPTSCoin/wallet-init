...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to CPTS Core.", Q_NULLPTR));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where CPTS Core will store its data.", Q_NULLPTR));
        sizeWarningLabel->setText(QApplication::translate("Intro", "CPTS Core will download and store a copy of the CPTS block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", Q_NULLPTR));
