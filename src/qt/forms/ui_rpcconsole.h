...
public:
    ...
    QLabel *wallet_customzabetbackuppath_label;
    QLabel *wallet_customzabetbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzabetbackuppath_label = new QLabel(tab_repair);
        wallet_customzabetbackuppath_label->setObjectName(QStringLiteral("wallet_customzabetbackuppath_label"));
        wallet_customzabetbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzabetbackuppath_label, 4, 0, 1, 1);

        wallet_customzabetbackuppath = new QLabel(tab_repair);
        wallet_customzabetbackuppath->setObjectName(QStringLiteral("wallet_customzabetbackuppath"));
        wallet_customzabetbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzabetbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzabetbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
        wallet_customzabetbackuppath->setVisible(false);

        gridLayout_4->addWidget(wallet_customzabetbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the CPTS debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzabetbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zCPTS Backup Path:", Q_NULLPTR));
        wallet_customzabetbackuppath->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
