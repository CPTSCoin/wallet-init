...
public:
    ...
    void setupUi(QWidget *MasternodeList)
    {
        ...
        gridLayout = new QGridLayout(MasternodeList);
        ...
        configureMasternodeButton = new QPushButton(myMasternodeList);
        ...
        gridLayout->addLayout(verticalLayout_Master, 0, 0, 1, 1);


        retranslateUi(MasternodeList);

        tabAllMasternode->setCurrentIndex(1);
