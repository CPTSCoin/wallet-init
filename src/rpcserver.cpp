...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CPTS features */
        {"cpts", "masternode", &masternode, true, true, false},
        {"cpts", "listmasternodes", &listmasternodes, true, true, false},
        {"cpts", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cpts", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cpts", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cpts", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cpts", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cpts", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cpts", "masternodedebug", &masternodedebug, true, true, false},
        {"cpts", "startmasternode", &startmasternode, true, true, false},
        {"cpts", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cpts", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cpts", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cpts", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cpts", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cpts", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cpts", "mnbudget", &mnbudget, true, true, false},
        {"cpts", "preparebudget", &preparebudget, true, true, false},
        {"cpts", "submitbudget", &submitbudget, true, true, false},
        {"cpts", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cpts", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cpts", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cpts", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cpts", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cpts", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cpts", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cpts", "checkbudgets", &checkbudgets, true, true, false},
        {"cpts", "mnsync", &mnsync, true, true, false},
        {"cpts", "spork", &spork, true, true, false},
        {"cpts", "getpoolinfo", &getpoolinfo, true, true, false},
        {"cpts", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> cpts-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:44334/\n";
}
