...
RESOURCES += src/qt/cpts.qrc src/qt/cpts_locale.qrc

TRANSLATIONS += src/qt/locale/cpts_bg.ts \
                src/qt/locale/cpts_de.ts \
                src/qt/locale/cpts_en.ts \
                src/qt/locale/cpts_es.ts \
                src/qt/locale/cpts_fi.ts \
                src/qt/locale/cpts_fr.ts \
                src/qt/locale/cpts_it.ts \
                src/qt/locale/cpts_ja.ts \
                src/qt/locale/cpts_pl.ts \
                src/qt/locale/cpts_pt.ts \
                src/qt/locale/cpts_ru.ts \
                src/qt/locale/cpts_sk.ts \
                src/qt/locale/cpts_sv.ts \
                src/qt/locale/cpts_vi.ts \
                src/qt/locale/cpts_zh_CN.ts \
                src/qt/locale/cpts_zh_TW.ts
